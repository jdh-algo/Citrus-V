...
from ..preprocessor import AutoPreprocessor, GroundingMixin, MessagesPreprocessor, ResponsePreprocessor, RowPreprocessor
from ..register import DatasetMeta, SubsetDataset, register_dataset


class GeneralRefSegPreprocessor(MessagesPreprocessor):

    def __init__(self, data_root_path: str, **kwargs):
    ...
    def preprocess(self, row: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        images, masks = row['images'], row['masks']
        if not images or not masks:
            return

        images = [os.path.join(self.data_root_path, image) for image in images]
        masks = [os.path.join(self.data_root_path, mask) for mask in masks]

        row['images'], row['masks'] = images, masks

        return row


# public medsam2d dataset, segment, 10k dataset
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/medsam_2d/WORD_10000_20250826.json',
        dataset_name='medsam2d_seg_10k_20250826_word',
        preprocess_func=GeneralRefSegPreprocessor(
            data_root_path='/mnt/workspace/offline/shared_data/SA-Med2D-20M/SAMed2Dv1'),
    ))
# public medsam2d dataset, detect, 10k dataset
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/medsam_2d/WORD_10000_20250826_detect.json',
        dataset_name='medsam2d_det_10k_20250826_word',
    ))
# medsam2d dataset, segment, 30k dataset
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/medsam_2d/medsam2d_segment_30k_20250828.json',
        dataset_name='medsam2d_seg_30k_20250828',
        preprocess_func=GeneralRefSegPreprocessor(
            data_root_path='/mnt/workspace/offline/shared_data/SA-Med2D-20M/SAMed2Dv1'),
    ))
# medsam2d dataset, detect, 30k dataset
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/medsam_2d/medsam2d_detect_30k_20250828.json',
        dataset_name='medsam2d_det_30k_20250828',
    ))

# medsam2d dataset, segment, 32k dataset, optimize duplicate logic
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/medsam_2d/medsam2d_segment_32k_20250901.json',
        dataset_name='medsam2d_seg_32k_20250901',
        preprocess_func=GeneralRefSegPreprocessor(
            data_root_path='/mnt/workspace/offline/shared_data/SA-Med2D-20M/SAMed2Dv1'),
    ))
# medsam2d dataset, detect, 32k dataset, optimize duplicate logic
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/medsam_2d/medsam2d_detect_32k_20250901.json',
        dataset_name='medsam2d_det_32k_20250901',
    ))

# medseg_bench, 9.7k dataset, segment
register_dataset(
    DatasetMeta(
        dataset_path='/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/MedSegBench/medseg_bench_train_val.json',
        dataset_name='medseg_bench_10k',
        preprocess_func=GeneralRefSegPreprocessor(data_root_path='/mnt/workspace/offline/shared_data/MedSegBench'),
    ))

# medsam2d dataset, segment, 29k dataset, optimize duplicate logic
register_dataset(
    DatasetMeta(
        dataset_path=
        '/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/medsam_2d/medsam2d_segment_wooverlap_29k_20250901.json',
        dataset_name='medsam2d_seg_wooverlap_29k_20250901',
        preprocess_func=GeneralRefSegPreprocessor(
            data_root_path='/mnt/workspace/offline/shared_data/SA-Med2D-20M/SAMed2Dv1'),
    ))
register_dataset(
    DatasetMeta(
        dataset_path=
        '/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/medsam_2d/medsam2d_detect_wooverlap_29k_20250901.json',
        dataset_name='medsam2d_det_wooverlap_29k_20250901',
    ))
register_dataset(
    DatasetMeta(
        dataset_path=
        '/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/medsam_2d/medsam2d_detect_wooverlap_29k_20250901_fixed.json',
        dataset_name='medsam2d_det_wooverlap_29k_20250901_fixed',
    ))
...
register_dataset(
    DatasetMeta(
        dataset_path=
        '/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/medsam_2d/medsam2d_CT_segment_wooverlap_20k_20000_20250918.json',
        dataset_name='medsam2d_seg_woorerlap_20k_CT_20250918',
        preprocess_func=GeneralRefSegPreprocessor(
            data_root_path='/mnt/workspace/offline/shared_data/SA-Med2D-20M/SAMed2Dv1'),
    ))
# 0920 add
register_dataset(
    DatasetMeta(
        dataset_path=
        '/mnt/workspace/offline/caoxuyang5/code/ms-swift-370-main/data/medsam_2d/medsam2d_FP_segment_5000_20250828.json',
        dataset_name='medsam2d_FP_segment_5k_20250828',
        preprocess_func=GeneralRefSegPreprocessor(
            data_root_path='/mnt/workspace/offline/shared_data/SA-Med2D-20M/SAMed2Dv1'),
    ))
...
register_dataset(
    DatasetMeta(
        dataset_path=
        '/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/private_CT_dataset/private_seg_dataset_1k.json',
        dataset_name='private_seg_dataset_1k',
        preprocess_func=GeneralRefSegPreprocessor(
            data_root_path='/mnt/workspace/offline/shared_data/private_seg_dataset_ct_processed'),
    ))
register_dataset(
    DatasetMeta(
        dataset_path=
        '/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/private_CT_dataset/private_det_dataset_1k.json',
        dataset_name='private_det_dataset_1k',
    ))

# medseg_bench, 10.2k dataset, segment
register_dataset(
    DatasetMeta(
        dataset_path=
        '/mnt/workspace/offline/caoxuyang5/code/ms-swift/data/MedSegBench/medseg_bench_train_val_ENG_oversampling.json',
        dataset_name='medseg_bench_10k_oversample',
        preprocess_func=GeneralRefSegPreprocessor(data_root_path='/mnt/workspace/offline/shared_data/MedSegBench'),
    ))
