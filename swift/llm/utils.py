...
def dynamic_gradient_checkpointing(model, including_vit: bool = False) -> None:
    # print(f"===== language model: {model.mllm.model.language_model}")
    ...
    if model_meta.is_multimodal and model_arch:
        ...
        if model_arch.grounding_encoder:
            tower_names += model_arch.grounding_encoder
    else:
        tower_names = [None]

    # print(f"====== tower_names: {tower_names}")
    ...
    for tower_name in tower_names:
        ...
        # print(f"====== model_tower: {model_tower}")
