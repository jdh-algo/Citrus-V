...
class TunerMixin:
    ...
    def prepare_model(cls, args, model, *, template=None, train_dataset=None, task_type=None):
        ...
        if args.is_adapter:
            ...
            # 新增：冻结自定义参数列表
            if hasattr(args, 'freeze_custom_parameters_json') and args.freeze_custom_parameters_json:
                from freeze_top_parameters import freeze_custom_parameters
                freeze_custom_parameters(model, args.freeze_custom_parameters_json)
