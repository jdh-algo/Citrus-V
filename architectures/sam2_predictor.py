...
import torch
from architectures.sam2_base import SAM2Base
from architectures.third_parts.sam2.modeling.sam2_base import NO_OBJ_SCORE
from architectures.third_parts.sam2.utils.misc import fill_holes_in_mask_scores
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def add_language_embd(
        ...
        if inference:
            ...
            # )
        # print(f"===== pred_mask_gpu: {pred_mask_gpu.shape}")
    ...
    def _run_memory_encoder(self, inference_state, frame_idx, batch_size, high_res_masks, is_mask_from_pts):
        ...
        maskmem_features = maskmem_features.to(storage_device, non_blocking=True)
        # "maskmem_pos_enc" is the same across frames, so we only need to store one copy of it
        maskmem_pos_enc = _get_maskmem_pos_enc(inference_state, {'maskmem_pos_enc': maskmem_pos_enc})
    ...
    def propagate_in_video_preflight(self, inference_state):
        ...
        for is_cond in [False, True]:
            ...
            for frame_idx in temp_frame_inds:
                ...
                clear_non_cond_mem = self.clear_non_cond_mem_around_input and (self.clear_non_cond_mem_for_multi_obj
                                                                               or batch_size <= 1)
